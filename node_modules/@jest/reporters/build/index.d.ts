...
export type { Config } from '@jest/reporters/node_modules/@jest/types';
...
export declare const utils: {
    formatTestPath: (config: import("@jest/reporters/node_modules/@jest/types/build/Config").ProjectConfig | import("@jest/reporters/node_modules/@jest/types/build/Config").GlobalConfig, testPath: string) => string;
    ...
    relativePath: (config: import("@jest/reporters/node_modules/@jest/types/build/Config").ProjectConfig | import("@jest/reporters/node_modules/@jest/types/build/Config").GlobalConfig, testPath: string) => {
        basename: string;
        dirname: string;
    };
    trimAndFormatPath: (pad: number, config: import("@jest/reporters/node_modules/@jest/types/build/Config").ProjectConfig | import("@jest/reporters/node_modules/@jest/types/build/Config").GlobalConfig, testPath: string, columns: number) => string;
};
