...
import type { Definition } from '@typescript-eslint/scope-manager/dist/definition';
import type { ReferenceImplicitGlobal } from '@typescript-eslint/scope-manager/dist/referencer/Reference';
import { Reference, ReferenceFlag } from '@typescript-eslint/scope-manager/dist/referencer/Reference';
import type { ScopeManager } from '@typescript-eslint/scope-manager/dist/ScopeManager';
import { Variable } from '@typescript-eslint/scope-manager/dist/variable';
import type { FunctionScope } from '@typescript-eslint/scope-manager/dist/scope/FunctionScope';
import type { GlobalScope } from '@typescript-eslint/scope-manager/dist/scope/GlobalScope';
import type { ModuleScope } from '@typescript-eslint/scope-manager/dist/scope/ModuleScope';
import type { Scope } from '@typescript-eslint/scope-manager/dist/scope/Scope';
import { ScopeType } from '@typescript-eslint/scope-manager/dist/scope/ScopeType';
import type { TSModuleScope } from '@typescript-eslint/scope-manager/dist/scope/TSModuleScope';
