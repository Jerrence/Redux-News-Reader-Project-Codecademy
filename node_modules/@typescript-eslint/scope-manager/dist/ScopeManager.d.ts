...
import type { Scope } from '@typescript-eslint/scope-manager/dist/scope';
import { BlockScope, CatchScope, ClassScope, ConditionalTypeScope, ForScope, FunctionExpressionNameScope, FunctionScope, FunctionTypeScope, GlobalScope, MappedTypeScope, ModuleScope, SwitchScope, TSEnumScope, TSModuleScope, TypeScope, WithScope } from '@typescript-eslint/scope-manager/dist/scope';
import { ClassFieldInitializerScope } from '@typescript-eslint/scope-manager/dist/scope/ClassFieldInitializerScope';
import { ClassStaticBlockScope } from '@typescript-eslint/scope-manager/dist/scope/ClassStaticBlockScope';
import type { Variable } from '@typescript-eslint/scope-manager/dist/variable';
