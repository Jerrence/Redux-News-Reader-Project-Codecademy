import { dispatchEvent, dispatchUIEvent } from '@testing-library/user-event/dist/types/event';
import { Options } from '@testing-library/user-event/dist/types/options';
import { System } from '@testing-library/user-event/dist/types/system';
import * as userEventApi from '@testing-library/user-event/dist/types/setup/api';
import { DirectOptions } from '@testing-library/user-event/dist/types/setup/directApi';
