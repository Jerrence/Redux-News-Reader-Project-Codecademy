import { setupMain } from '@testing-library/user-event/dist/types/setup/setup';
import * as directApi from '@testing-library/user-event/dist/types/setup/directApi';
export type { Instance } from '@testing-library/user-event/dist/types/setup/setup';
