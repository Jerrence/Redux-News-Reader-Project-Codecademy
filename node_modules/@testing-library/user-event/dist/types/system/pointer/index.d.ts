...
import { pointerKey, PointerPosition } from '@testing-library/user-event/dist/types/system/pointer/shared';
export type { pointerKey, PointerPosition } from '@testing-library/user-event/dist/types/system/pointer/shared';
