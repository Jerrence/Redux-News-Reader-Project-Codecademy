import { PointerCoords } from '@testing-library/user-event/dist/types/event';
import { MouseButton } from '@testing-library/user-event/dist/types/system/pointer/buttons';
