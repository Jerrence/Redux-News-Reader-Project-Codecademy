import type { CompiledQuery, Options, Query, Adapter } from "css-select/lib/types";
export type { Options };
/**
...
export declare const _compileToken: <Node_1, ElementNode extends Node_1>(selector: import("css-select/lib/types").InternalSelector[][], options?: Options<Node_1, ElementNode> | undefined, context?: Node_1 | Node_1[] | undefined) => CompiledQuery<ElementNode>;
